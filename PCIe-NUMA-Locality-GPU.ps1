#Author: Frank Denneman - https://twitter.com/frankdenneman
#Contributors: KMRuddy and LucDekens
...
#The PCI address is transformed from a hexidecimal value to a decimal value
